...
data class DBEvent(val id: Long?, val eventId: String?, val homeTeamId: String?,
                   val homeTeam: String?, val awayTeamId: String?, val awayTeam: String?,
                   val homeScore: String?, val awayScore: String?, val dateEvent: String?) {

    companion object {
        const val TABLE_EVENT: String = "TABLE_FAVORITE"
